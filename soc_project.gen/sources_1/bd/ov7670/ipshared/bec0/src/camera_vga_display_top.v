...
buffer_RAM_12x131072 buffer_RAM_12x131072 (
  // write from camera ov7670
  .i_wclk(clk_50mhz),    // input wire clka
  .i_wr(wea),      // input wire [0 : 0] wea
  .i_wr_addr(save_address),  // input wire [16 : 0] addra
  .i_bram_data(RGB_444_data),    // input wire [11 : 0] dina
  // read to VGA output
  .i_rclk(clk_50mhz),    // input wire clkb
  .i_rd_addr(read_address),  // input wire [16 : 0] addrb
  .o_bram_data(doutb)  // output wire [11 : 0] doutb
);
